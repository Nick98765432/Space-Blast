...
func _on_normal_button_up() -> void:
	...
	get_tree().change_scene_to_file(
		"res://Levels/Level levels/group 1/Level 1-1.tscn"
	)
...
func _on_level_12_button_up() -> void:
	...
	PlayerData.weapons = [1, 2, 3]
	get_tree().change_scene_to_file(
		"res://Levels/Level levels/group 1/Level 1-2.tscn"
	)
...
func _on_level_13_button_up() -> void:
	...
	PlayerData.weapons = [1, 2, 3]
	get_tree().change_scene_to_file(
		"res://Levels/Level levels/group 1/Level 1-3.tscn"
	)
...
func _on_level_21_button_up() -> void:
	...
	PlayerData.weapons = [1, 2, 3]
	get_tree().change_scene_to_file(
		"res://Levels/Level levels/group 2/Level 2-1.tscn"
	)
...
func _on_level_22_button_up() -> void:
	...
	PlayerData.weapons = [1, 2, 3]
	get_tree().change_scene_to_file(
		"res://Levels/Level levels/group 2/Level 2-2.tscn"
	)
...
func _on_level_23_button_up() -> void:
	...
	PlayerData.weapons = [1, 2, 3]
	get_tree().change_scene_to_file(
		"res://Levels/Level levels/group 2/Level 2-3.tscn"
	)
